      ...
      <div v-if="gameCode" class="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-6 mb-6 border-2 border-yellow-300">
        <div class="text-center">
          ...
          <div class="flex flex-wrap justify-center gap-3">
            ...
            <button
              @click="copyGameCode"
              class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105 flex items-center space-x-2"
            >
            ...
            <button
              ...
              class="px-4 py-2 bg-[#1877F2] text-white rounded-lg hover:bg-[#166FE5] transition-all transform hover:scale-105 flex items-center space-x-2"
            >
            ...
            <button
              ...
              class="px-4 py-2 bg-[#1DA1F2] text-white rounded-lg hover:bg-[#1a8cd8] transition-all transform hover:scale-105 flex items-center space-x-2"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              class="px-4 py-2 bg-[#25D366] text-white rounded-lg hover:bg-[#20ba5a] transition-all transform hover:scale-105 flex items-center space-x-2"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
