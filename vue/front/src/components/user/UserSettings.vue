<template>
  <div class="flex min-h-screen">
    <UserSidebar />
    <div class="flex-1 ml-20 md:ml-64 min-h-screen max-w-4xl mx-auto px-4 sm:px-3 md:px-6 lg:px-8 py-4 sm:py-3 md:py-6 transition-all duration-300 mt-16 pt-4 sm:pt-6 pb-6 md:pb-6" :class="sidebarCollapsed ? 'md:ml-20' : ''">
